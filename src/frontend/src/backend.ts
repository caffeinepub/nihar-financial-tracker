...
export class Backend implements backendInterface {
    ...
    async storeAnalysis(arg0: Analysis): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.storeAnalysis(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadAndAnalyzeFile(arg0: ExternalBlob, arg1: Analysis): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadAndAnalyzeFile(await to_candid_ExternalBlob_n13(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
